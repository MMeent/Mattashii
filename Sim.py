...
def main():
    ...
    parser.add_argument("-ng", "--nogui", type=bool, help="No graphical user interface, just simulate the f*ck out of here", default=False, action="store_true")
    args = parser.parse_args()
    print "arguments: ", args

    if args.nogui == False:
        window = mattashii_ui.__init__()
    else:
